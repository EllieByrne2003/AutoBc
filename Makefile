...
# target macros
TARGET := bin/autobc # FILL: target filename
...
$(TARGET): build-subdirs $(OBJS) find-all-objs 
	# echo $(SOURCES)
	@echo -e "\t" CXX $(CXXFLAGS) $(SOURCES) -o $@ lib/libabc.a -lm -ldl -lreadline -lpthread # TODO Don't like this
	@$(CXX) -o $@ $(SOURCES) $(CXXFLAGS) lib/libabc.a -lm -ldl -lreadline -lpthread # TODO Don't like this
	# @rm -f $(ALL_OBJS)
	# @mv $(ALL_OBJS) obj
